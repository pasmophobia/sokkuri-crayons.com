/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8e45b4289db260a8696a2daa78e0936)
...
interface __BaseEnv_Env {
	...
	Post: DurableObjectNamespace<import("./src/worker").Post>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "Post";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAIL_FROM" | "BETTER_AUTH_SECRET">> {}
}
